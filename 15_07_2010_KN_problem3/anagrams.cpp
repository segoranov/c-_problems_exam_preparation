...
int countAnagrams_v2(const std::string& word, const std::vector<std::string>& words)
{
    int result = 0;
...
void test_v1()
{
    ...
    std::cout << "TEST_v1 should be 3. Actual: " << longestAnagramsCount_v1(7, input) << std::endl;
}

void test_v2()
{
    std::vector<std::string> input =
        { "string", "ginrts", "ringst", "strong", "spong", "shpong", "pongs" };
    
    std::cout << "TEST_v2 should be 3. Actual: " << longestAnagramsCount_v2(input) << std::endl;
}
